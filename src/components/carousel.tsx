        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="relative w-full h-full rounded-lg overflow-hidden shadow-lg group">
              ...
              />
              <div className="absolute bottom-5 inset-x-0 bg-opacity-50 flex flex-col justify-center items-center text-white">
                <h2 className="text-2xl font-bold">{slide.title}</h2>
                <p className="mt-2 text-center">{slide.description}</p>
                <p className="transition-transform transform group-hover:translate-y-0 translate-y-10 opacity-0 group-hover:opacity-100">
